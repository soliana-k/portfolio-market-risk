...
st.set_page_config(
    page_title="Phase 3 – Portfolio Construction",
    page_icon="📈",
    layout="wide",
    initial_sidebar_state="expanded",
)

st.title("📈 Phase 3 – Portfolio Construction")
st.caption(
...
with tab_pnl:
    ...
    cum_pnl = result.portfolio_pnl.cumsum()
    fig_c = px.line(
        x=cum_pnl.index,
        y=cum_pnl,
    ...
    fig_c.update_layout(height=360, template="plotly_white")
